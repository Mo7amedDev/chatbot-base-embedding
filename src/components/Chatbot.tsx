...
export default function Chatbot({ chatbotId, isOpen, onOpenChange }: ChatbotProps) {
  ...
  return (
    <div className="bottom-4 right-4 flex flex-col items-end z-[9999] min-w-14 min-h-14">
      ...
      <motion.div
        initial={false}
        animate={{ scale: isOpen ? 0.95 : 1, rotate: isOpen ? 45 : 0 }}
